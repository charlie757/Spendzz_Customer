...
import 'add_review_rating_forPasbook.dart';

class PassbookTransactionHistory extends StatefulWidget {
  var transaction_ID = '';
  var fromHomeScreen = "";

  PassbookTransactionHistory(this.transaction_ID, this.fromHomeScreen);

  @override
  _PassbookTransactionHistoryState createState() =>
      _PassbookTransactionHistoryState(transaction_ID, fromHomeScreen);
}

class _PassbookTransactionHistoryState
    extends State<PassbookTransactionHistory> {
  _PassbookTransactionHistoryState(this.transaction_ID, this.fromHomeScreen);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (fromHomeScreen == "DashBoard to PassBook") {
        ...
        } else if (fromHomeScreen == "FromNotifications") {
          if (Platform.isAndroid) {
            Navigator.push(context,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        {
                                          Navigator.push(
                                              context, MaterialPageRoute(builder: (context) => Add_Review_For_Pasbook(unique_key)));
