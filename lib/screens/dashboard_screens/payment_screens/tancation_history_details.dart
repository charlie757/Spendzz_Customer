...
class NormalTicketHistory extends StatefulWidget {
  var transaction_ID='';
  NormalTicketHistory(this.transaction_ID);
  @override
  _NormalTicketHistoryState createState() => _NormalTicketHistoryState(transaction_ID);
}

class _NormalTicketHistoryState extends State<NormalTicketHistory> {
  _NormalTicketHistoryState(this.transaction_ID);
  var transaction_ID='';
  ...
  _callTicketHistory() async {
    ...
    try {
      ...
      var uriResponse = await client.post(
        Uri.parse(ApiConfig.app_base_url + ApiConfig.TRANSACTION_HISTORY_TICKET),
        headers: headers,
        body: mapBody,
      );
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: FlatButton(
                onPressed: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) =>Raise_Ticket_Normal(transaction_ID)));
                },
                child: Text(
                  'Need Help?',
                  style: TextStyle(
