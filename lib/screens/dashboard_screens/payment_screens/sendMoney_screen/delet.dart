...
class SendPaymentWithQrCode extends StatefulWidget {
  const SendPaymentWithQrCode({Key? key}) : super(key: key);

  @override
  _SendPaymentWithQrCodeState createState() => _SendPaymentWithQrCodeState();
}

class _SendPaymentWithQrCodeState extends State<SendPaymentWithQrCode> {
  Barcode? result;
