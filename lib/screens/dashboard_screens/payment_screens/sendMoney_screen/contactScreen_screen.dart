                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  if (contacts![index].phones.isNotEmpty) {
                                    // mobileNo=contacts![index].phones.first.number.toString();
                                    _callCheckValidMobile(contacts![index]
                                        .phones
                                        .first
                                        .number
                                        .toString());
    ...
    try {
      ...
      if (uriResponse.statusCode == 200) {
        if (status == true) {
          ...
          prefs.setString(
              'CONTACT_NUMBER', dataAll['data']['mobile'].toString());
        ...
        if (status == false) {
          /* Fluttertoast.showToast(
                ...
                fontSize: 16.0);*/
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => InviteScreen(mobileNo)));
        }
      } else {
        EasyLoading.dismiss();
        Fluttertoast.showToast(
