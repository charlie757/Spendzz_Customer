...
import 'package:spendzz/screens/dashboard_screens/category_screens/slider_component/slide.dart';
import 'package:spendzz/screens/dashboard_screens/category_screens/slider_component/slide_dots.dart';
import 'package:spendzz/screens/dashboard_screens/category_screens/slider_component/slide_item.dart';
...
class CategoryDetails extends StatefulWidget {
  ...
  @override
  _CategoryDetailsState createState() => _CategoryDetailsState(shopId, merchantId,shopNameSingleCategory);
}
class _CategoryDetailsState extends State<CategoryDetails> {


  _CategoryDetailsState(this.shopId, this.merchantId,this.shopNameSingleCategory,);
  var shopId = '';
  var merchantId = '';
  var shopNameSingleCategory = '';
  ...
  _categoryDetails(String tokenData) async {
    ...
    try {
      ...
      var uriResponse = await client.post(
          Uri.parse(
              ApiConfig.app_base_url + ApiConfig.CATEGORY_DETAIL),
          headers: headers,
          body: mapBody);
        ...
        /*//  var ratingArray = arrResults['merchant_avg_rating'];
         ...
         /* isDataFetched = true;
          ...
          for (var i = 0; i < sliderImage.length; i++) {
            ...
            mdlSubData.image = singleCategory_baseUrl+'/'+dictResult['image'].toString();
            mdlSubData.image = singleCategory_baseUrl+'/'+dictResult['image'].toString();
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:  shopName,hintStyle: TextStyle(
                          color: Colors.black
                        ),
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        autocorrect: true,
                        decoration: InputDecoration(
                          hintText:  shopMobileNo,hintStyle: TextStyle(
                            color: Colors.black
                        ),
                          focusedBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: Color(0xff787D86)),
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        autocorrect: true,
                        decoration: InputDecoration(
                          hintText:  shopAddress,hintStyle: TextStyle(
                            color: Colors.black
                        ),
                          focusedBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: Color(0xff787D86)),
  ...
  void nextScreen() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => PayMoneyScreen(CategoryPay,"CategoryBack")));
  }
  void viewRatingScreenScreen() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => ReviewAndRating(unique_key)));
  }
}
