...
class Review_Rating_For_History extends StatefulWidget {
  var unique_key='';
  Review_Rating_For_History(this.unique_key,);

  @override
  _Review_Rating_For_HistoryState createState() => _Review_Rating_For_HistoryState(unique_key);
}

class _Review_Rating_For_HistoryState extends State<Review_Rating_For_History> {
  _Review_Rating_For_HistoryState(this.unique_key);
  var unique_key='';
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if(addRating=='')
                        ...
                        {
                          _callReview_Rating_For_HistoryDataListings();
                        }
  ...
  _callReview_Rating_For_HistoryDataListings() async {
