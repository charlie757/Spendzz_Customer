...
import '../dashboard_screens/payment_screens/tancation_history_details.dart';
import 'help_screens/normal_ticket/raise_normal_ticket.dart';
...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  _callHistoryFitter() async {
    ...
    try {
      ...
      var uriResponse = await client.post(Uri.parse(ApiConfig.app_base_url + ApiConfig.FILTER_HISTORY), headers: headers, body: mapBody,);
      var dataAll = json.decode(uriResponse.body);
      EasyLoading.dismiss();
      setState(() {
        trancationHistoryList.clear();
